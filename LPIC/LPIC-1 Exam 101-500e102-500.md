...
O `iproute2` é uma implementação mais moderna, e a tendencia é utilizá-lo no lugar dos comandos do pacote `net-tools`.

## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg4NTk0MzM0OSwtMTg0NDUxMjkzNywtMz
