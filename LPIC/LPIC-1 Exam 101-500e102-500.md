...
- `passwd -l lpi2` (ou `--lock`): trava (lock) o usuário `lpi2` (colocar `!` no primeiro caracter do campode senha do `/etc/shadow`) - usando quando precisa investigar o usuário. Para destravar `passwd -u lpi1` (ou `--unlock`): retira a exclamação `/etc/shadow`

## 110.2 Configurar a segurança do host

## 110.3 Proteção de dados com criptografia
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNDEwODIxODIsMjE0MTQ3NDE3MCwtND
k4ODAyODM2LDExMTMwNjI5MDAsLTE5NTg1ODkxNzUsLTE4NTUx
NTg3ODEsNTI1MDQzMzAxLC0yMDIwNTIxNjI3LC01MzgwOTA4MD
csNDE4NjI1MjYwLDE1NzMyNDUxOTAsMTA5Nzg3NTY2NCwtMTc3
ODAxNjc1NSwxNTUwMTk1MTIzLC0xNjQxNjM4NjcsLTUzMTM2Mz
M0LC01NDM3ODM0MTAsLTIxMDg2MDQxNDcsMTM2NjQ5NjIwLDE1
OTAyNzczOTBdfQ==
-->