...
-`ifconfig enp0s8 down`: baixa a interface (se der `ifconfig`, não mostrará mais, para mostrar precisar usar `ifconfig -a` - display all interfaces which are currently available, even if `down`)
...
- `w`: mostra quem está logado e o que está fazendo (Show who is logged on and what they are doing.). Se voltar lá no `tty2` e executar o `top`, voltar para `tty7` e digitar `w`, mostra todas as informações do que o usuário que logou no `tty2` está fazendo, quanto está consumindo, etc

## 110.2 Configurar a segurança do host

## 110.3 Proteção de dados com criptografia
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkzOTE0MTY4OSwtMTg1NTE1ODc4MSw1Mj
UwNDMzMDEsLTIwMjA1MjE2MjcsLTUzODA5MDgwNyw0MTg2MjUy
NjAsMTU3MzI0NTE5MCwxMDk3ODc1NjY0LC0xNzc4MDE2NzU1LD
E1NTAxOTUxMjMsLTE2NDE2Mzg2NywtNTMxMzYzMzQsLTU0Mzc4
MzQxMCwtMjEwODYwNDE0NywxMzY2NDk2MjAsMTU5MDI3NzM5MC
w3NDg1NjMyOTEsMTEzMTYzODA4Nyw0NDE1MjY4NDksMTY4OTE2
OTU2Ml19
-->