...
- `passwd -w4 lpi2`: número de dias que vai alertar que a senha vai expirar (Number of days of warning before password expires). No cha

## 110.2 Configurar a segurança do host

## 110.3 Proteção de dados com criptografia
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0MDI2NTg0NSwyMTQxNDc0MTcwLC00OT
