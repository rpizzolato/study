...
Depois da coluna de `facility.priority`, seria onde se destina o log, no caso pode ser um caminho (/var/log/syslog, por exemplo) ou pode ser para um determinado usuário (lpi1,lpi2 - separado pode vírgula)



<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM0ODIwNjQ4NiwtMTQwODExMzEwNCwtMT
QxMTUxMTYzMCwtNTIwMDU2MjM3XX0=
-->