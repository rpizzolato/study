...
- `find / -path /proc -prune -nouser -ls`: mostra todos os arquivos que não tem usuários associados, exclui o `/proc` da busca (`-path /proc -prune`). Geralmente acontece quando exclui usuá
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY1MjU4ODU4NCwxNDQ2MTU3MTM4LC0xMz
