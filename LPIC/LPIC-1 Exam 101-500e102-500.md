...
- `ip addr del 192.168.1.50/24 dev enp0s2` ou `ip addr flush 192`: remove o IP 192.168.1.50 da interface enp0s2

## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc2MjYyMjI3OCwxNTEwMzU1OTE1LC0xOD
