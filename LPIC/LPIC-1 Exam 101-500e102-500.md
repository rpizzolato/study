...
É possível perceber que o log do `syslog` vai rotacionando, de syslog vira syslog.1, depois é compactado, e o úlimo 

- `/etc/logrotate.conf`: arquivo de configuração do logrotate.

<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEzNDM4MjQ5OCwxOTYyNjY0MTczLC01Nz
