...
- `hosts`: vai estar como `files`, o que indica para buscar primeiramente aos arquivos do sistema, como o `/etc/hosts` (o que faz relação IP e nome), e 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQyNTM2NDg2NiwtMTI0NTIxMTY4Myw3OT
