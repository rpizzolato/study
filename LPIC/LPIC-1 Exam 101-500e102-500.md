...
- `nmcli device disconnect wlo1`: desconectar da rede conectada anteriormente (não chega a desligar a interface).

## 109.3 Resolução de problemas básicos de rede
## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzQwMTI1MzU0LDQ4MDE5MDY1MywtMTk3Mz
