...
Importante dizer que esse arquivo é dinamicamente gerenciado/escrito pelo `systemd-resolved(8)`, que basicamente é um link que vem do `/etc/resolv.conf`
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3MzY2OTU1MCwxNTM1MzAyNDMzLC0xMj
...
MzU2OCwtMzAyMTE3NjczLDI0NjM2MTQ0OCwtMTMyNzc1MDg0Ni
wxNzA1NDExMzk0LDgwNzQzOTA3MSwzMjA1MDUwMDAsLTIwMjI1
MTUyMzFdfQ==
-->