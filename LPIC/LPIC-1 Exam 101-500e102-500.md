...
Monitoramento das portas, quais estão abertas, e etc.
- `netstat -anpt`: verifica todas portas abertas (`-a` ou `--all` ), não resolver os nomes (`-n` ou `--numeric`), mostrar o `pid` dos processos (`-p` ou `--program`), ouvindo somente TCP 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2OTAyMTc2OSwtMTc3NzU3MDIzNiwxNT
k2OTExOTk1LC01NDMxODE0MDEsMTgyMzQzNjM4NiwtMTg4NDkx
Nzk5MiwxMDQ3NTY4NDkzLC0xMDY3NzM3MDkwLDE4MjI3OTMwMS
wtMTI0MTA4MjE4MiwyMTQxNDc0MTcwLC00OTg4MDI4MzYsMTEx
MzA2MjkwMCwtMTk1ODU4OTE3NSwtMTg1NTE1ODc4MSw1MjUwND
MzMDEsLTIwMjA1MjE2MjcsLTUzODA5MDgwNyw0MTg2MjUyNjAs
MTU3MzI0NTE5MF19
-->