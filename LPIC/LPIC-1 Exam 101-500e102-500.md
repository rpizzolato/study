...
- `%sudo ALL=(ALL:ALL) ALL`: mesmo raciocínio, agora para o grupo `sudo`. O usuário criado na instalação, muito provavelmente estará nesse grupo.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM3MjMwNTI1OSw0MTg2MjUyNjAsMTU3Mz
