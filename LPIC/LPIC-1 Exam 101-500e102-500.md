...
- nmcli device: resumo das interfaces
- nmcli device show: mostra mais detalhes das interfaces (mostra IP, máscara formato CIDR, rota padrão e DNS)
- nmcli device show en: mostra mais detalhes das interfaces (mostra IP, máscara formato CIDR, rota padrão e DNS)


## 109.3 Resolução de problemas básicos de rede
## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM0NzQyMDY4OSwxODQ3MzAxMDc2LDIwMD
