...
No entanto é possível mudar o gerenciamento para o **systemd-networkd**. Basta parar o NetworkManager (systemctl stop)


## 109.3 Resolução de problemas básicos de rede
## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc3Mjk3NTg3MCwtMTM0NzkwODQzNCwtMj
