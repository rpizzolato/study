...
- `lastb`: histórico de usuários que tentaram se logar, mas erraram a senha, ou usuário não existia. Esses dados (do `last`) são consultados de `/var/log/wtmp` (arquivo binário). Para ler usar last -f `/var/log/wtmp` (`-f` ou `--file`). O lastb é lido em /eva

## 110.2 Configurar a segurança do host

## 110.3 Proteção de dados com criptografia
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkwNDE2MTIzNCwtMTk1ODU4OTE3NSwtMT
g1NTE1ODc4MSw1MjUwNDMzMDEsLTIwMjA1MjE2MjcsLTUzODA5
MDgwNyw0MTg2MjUyNjAsMTU3MzI0NTE5MCwxMDk3ODc1NjY0LC
0xNzc4MDE2NzU1LDE1NTAxOTUxMjMsLTE2NDE2Mzg2NywtNTMx
MzYzMzQsLTU0Mzc4MzQxMCwtMjEwODYwNDE0NywxMzY2NDk2Mj
AsMTU5MDI3NzM5MCw3NDg1NjMyOTEsMTEzMTYzODA4Nyw0NDE1
MjY4NDldfQ==
-->