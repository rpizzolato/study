...
Importante dizer que esse arquivo é dinamicamente gerenciado/escrito/gerado pelo `systemd-resolved(8)`, que basicamente é um link que vem do `/etc/resolv.conf`. Isso significa que poderia ter seu próprio arquivo parecido com `resolv.conf` apontando para o `resolv` do `systemd` (para ambiente de produção, por exempl).
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTA3NzYwNjgsMTUzNTMwMjQzMywtMTI0NT
IxMTY4Myw3OTQ5MDg2MTAsLTE1MjA4MDA1OSwtNTE5Mjg2MDY5
LC0yMDk3MDI2ODAzLC04ODU5OTcwNzAsLTgyMzU2MTgyLDE0NT
UyMDA4NDQsLTg5OTUyNzg1MCwtNjMxNjI1MjExLC01ODU5NDM1
NjgsLTMwMjExNzY3MywyNDYzNjE0NDgsLTEzMjc3NTA4NDYsMT
cwNTQxMTM5NCw4MDc0MzkwNzEsMzIwNTA1MDAwLC0yMDIyNTE1
MjMxXX0=
-->