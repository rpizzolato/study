...
-  ip route show: mostra as rotas, como a default (pc que não está navegando, pode ser que está sem rota default)

## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMxMDA0NjQ4MCwxNTEwMzU1OTE1LC0xOD
