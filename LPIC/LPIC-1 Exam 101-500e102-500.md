...
No caso, a 2ª linha indica que tudo (`*`), relacionado à facility e priority (`*.*` - qualquer facility e qualquer priority), exceto `;auth,authpriv.none`, irão gerar log em `/var/log/syslog`



<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYwMzYxODIzMywxMTY2NDYxMDksLTE0MD
gxMTMxMDQsLTE0MTE1MTE2MzAsLTUyMDA1NjIzN119
-->