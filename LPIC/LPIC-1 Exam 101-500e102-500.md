...
Semelhante ao `traceroute` é o `tracepath`. O `tracepath` não precisa ser root para excutar, como acontece com algumas opções do `traceroute`.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM3NzMxMzAyNSwtMTM1MjExNTE1MiwxMz
