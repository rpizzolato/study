...
Partindo do cenário que `/usr/bin/passwd` tem o bit **SUID** ligado (`rwsr-xr-x`) e que qualquer usuário pode executá-lo como `root`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTczNzE2MjQ5LC0xODg0OTE3OTkyLDEwND
