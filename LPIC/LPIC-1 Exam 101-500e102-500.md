...
- as demais são utilizadas para serviços específicos ou para a porta de socket de uma conexão (quando u )
<br>
Exemplo:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQxMjM0MjYzMiwtNTE5Mjg2MDY5LC0yMD
