...
- /etc/nsswitch.conf (Name Service Switch): disponibiliza diversas informações, de onde buscar as informações de passwd, group, shadow, etc. Geralmente é indicado como compat (
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU3ODg4MDQ0NywtMTI0NTIxMTY4Myw3OT
