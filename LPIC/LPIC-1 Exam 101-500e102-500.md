...
- **TCP**: Transmission Control Protocol: protocolo de transporte orientado a conexões. Garante a entrega dos pacotes na ordem correta. O pacote é retransmitido em caso de erros na rede. Usado por serviços como FTP, SMTP, HTTP, etc
...
- as primeiras 1024 portas são reservadas a serviços conhecidos (_portas privilegiadas_)
- as demais são utilizadas para serviços específicos ou para a porta de socket de uma conexão (quando um cliente se conecta a um servidor http, o servidor normalmente usa a porta 80, já no cliente é configurado um socket/porta aleatório, como 42222, por exemplo. Essa porta é chamada de socket)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzg0NDQyNjM3LC0xNTIwODAwNTksLTUxOT
I4NjA2OSwtMjA5NzAyNjgwMywtODg1OTk3MDcwLC04MjM1NjE4
MiwxNDU1MjAwODQ0LC04OTk1Mjc4NTAsLTYzMTYyNTIxMSwtNT
g1OTQzNTY4LC0zMDIxMTc2NzMsMjQ2MzYxNDQ4LC0xMzI3NzUw
ODQ2LDE3MDU0MTEzOTQsODA3NDM5MDcxLDMyMDUwNTAwMCwtMj
AyMjUxNTIzMSwxOTc5NDUxNTI2LC0xMTA5NzAxMzgxLC02MjM1
ODU2NjVdfQ==
-->