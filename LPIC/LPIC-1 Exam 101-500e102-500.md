...
- `who -aH` (`-a` = `--all` e `-H` = `--heading`, colocar um header): mostra mais detalhes, assim como os terminais que não estão em uso.

## 110.2 Configurar a segurança do host

## 110.3 Proteção de dados com criptografia
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjgzODEwNDQsLTE4NTUxNTg3ODEsNT
