...
- `ip link show`: mostra as interfaces em uso e se estão funcionando. Não mostra IP. `link` é referente às interfaces.
- `ip address show`: mostra com informações do IP

## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NjAwMzkxODcsMTUxMDM1NTkxNSwtMT
...
MDI3NDUsLTE2OTk3MzE5OTIsLTE4MTczNjUzNzMsLTEzNDc5MD
g0MzQsLTI1OTY0NjU2MywtMTYyOTA2NTE5MSwtMTAxMjQ3MTEs
NDgwMTkwNjUzXX0=
-->