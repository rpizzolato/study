...
- `hosts`: vai estar como `files`, o que indica para buscar primeiramente aos arquivos do sistema, como o `/etc/hosts` (o que faz relação IP e nome), e caso não encontre, vai buscar em algum DNS configurado (no arquivo vai estar o `mdns4_minimal`, que é um serviço de DNS interno - multi).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMzY0NDUzMzcsLTEyNDUyMTE2ODMsNz
k0OTA4NjEwLC0xNTIwODAwNTksLTUxOTI4NjA2OSwtMjA5NzAy
NjgwMywtODg1OTk3MDcwLC04MjM1NjE4MiwxNDU1MjAwODQ0LC
04OTk1Mjc4NTAsLTYzMTYyNTIxMSwtNTg1OTQzNTY4LC0zMDIx
MTc2NzMsMjQ2MzYxNDQ4LC0xMzI3NzUwODQ2LDE3MDU0MTEzOT
QsODA3NDM5MDcxLDMyMDUwNTAwMCwtMjAyMjUxNTIzMSwxOTc5
NDUxNTI2XX0=
-->