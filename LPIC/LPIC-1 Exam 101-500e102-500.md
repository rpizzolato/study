...
- `ip link set enp0s2 down` (para subir usa `up`): baixa a interface enp0s2 (retira o UP quando `ip link show`). Perde os IPs quando dá down e up

## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNDk3MzE4MTEsMTUxMDM1NTkxNSwtMT
