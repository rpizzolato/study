...
O `ss` é um comando do pacote `ip route` (mais moderno). O `netstat` pertence ao pacote `net-tools` (mais antigo). 


## 109.4 Configurar o DNS do lado do cliente

<!--stackedit_data:
eyJoaXN0b3J5IjpbNjAzNDgzNTkxLC0xMzUyMTE1MTUyLDEzOD
