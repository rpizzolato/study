...
- **rsyslog**: melhoramento do syslog (mais cobrado na LPI)
- **syslog-ng**: mesmo padrão do syslog, mas muda a implementação
...
Dando um cat onde está o socket visto anteriormente, `cat /lib/systemd/system/syslog.socket`, no campo **ListenDatagram**, mostra o que o syslog está ouvindo, que no caso é `/run/systemd/journal/syslog`. Nesse caso o rsyslog usa esse socket, por conta do módulo `imuxsock`
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEzNTM5NDIzMiwtMTA4ODY0MDA3NSwxMT
E2NTM2NzcxLC0xODIwNjYzOTk5LDE2NjUzMDY5MzQsLTg0NDY0
NDQxNiwtMTg4MzA0NjIzLC0xNDIyOTMyNTM3LDE5NjI2NjQxNz
MsLTU3OTU3MDEzNSwtNzI2MDgwNzI1LDMzMjgzNDYxOCwxMDAw
NzE4MzUwLDE2MDM2MTgyMzMsMTE2NjQ2MTA5LC0xNDA4MTEzMT
A0LC0xNDExNTExNjMwLC01MjAwNTYyMzddfQ==
-->