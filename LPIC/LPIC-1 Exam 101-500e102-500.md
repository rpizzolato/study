...
No caso, a 2ª linha indica que tudo (`*`), relacionado à facility e priority (`*.*` - qualquer facility e qualquer priority), exceto ;



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY4OTQwMzkxOSwxMTY2NDYxMDksLTE0MD
