...
- `passwd -l lpi2` (ou `--lock`): trava (lock) o usuário `lpi2` (colocar `!` no primeiro caractere do campo de senha do `/etc/shadow`) - usando quando precisa investigar o usuário. Para destravar `passwd -u lpi1` (ou `--unlock`): retira a exclamação `/etc/shadow`. Quando estiver lock, no `passwd -S lpi2` vai mostrar um `L` de `Locked`. Se estiver `unlocked`, vai mostrar um `P` de `Password`. No `chage` seria `chage -E` ou `--expiredate` para fazer lock do usuário

## 110.2 Configurar a segurança do host

## 110.3 Proteção de dados com criptografia
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgzOTA4ODI3MiwtMTI0MTA4MjE4MiwyMT
QxNDc0MTcwLC00OTg4MDI4MzYsMTExMzA2MjkwMCwtMTk1ODU4
OTE3NSwtMTg1NTE1ODc4MSw1MjUwNDMzMDEsLTIwMjA1MjE2Mj
csLTUzODA5MDgwNyw0MTg2MjUyNjAsMTU3MzI0NTE5MCwxMDk3
ODc1NjY0LC0xNzc4MDE2NzU1LDE1NTAxOTUxMjMsLTE2NDE2Mz
g2NywtNTMxMzYzMzQsLTU0Mzc4MzQxMCwtMjEwODYwNDE0Nywx
MzY2NDk2MjBdfQ==
-->