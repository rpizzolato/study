...
- **UDP**: User Datagram Protocol: protocolo de transporte não  orientado a conexões. Não oferece garantia de entr. Usado por serviços como FTP, SMTP, HTTP, etc
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTMxOTE0OTcsLTUxOTI4NjA2OSwtMj
