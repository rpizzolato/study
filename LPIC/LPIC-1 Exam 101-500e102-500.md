...
- `/etc/resolv.conf`: determinar qual servidor DNS será utilizado pelo sistema. Indica o `nameserver` (apenas um servidor de nomes é necessário, mas é possível informar até **três** deles - Os suplementares serão usados como reserva), que é basicamente o servidor DNS que irá usar. (mais detalhes no tópico **109.3**)
...
- `/lib/systemd/network` (com arquivos `.link` e `.network`) é onde
- `/etc/systemd/network`  ou ainda em
- `/run/systemd/netif`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ3NzEyNjA5MywtMTE3NjkyNTkwOSwtNj
c5NTAyNzQ1LC0xNjk5NzMxOTkyLC0xODE3MzY1MzczLC0xMzQ3
OTA4NDM0LC0yNTk2NDY1NjMsLTE2MjkwNjUxOTEsLTEwMTI0Nz
ExLDQ4MDE5MDY1MywtMTk3Mzk2MTU0MiwtMjEwNDIyNjM4LDgz
NjI2ODMwMiwxODQ3MzAxMDc2LDIwMDE4Njg0MjAsLTQzNTcxND
YyMiwxNTM1MzAyNDMzLC0xMjQ1MjExNjgzLDc5NDkwODYxMCwt
MTUyMDgwMDU5XX0=
-->