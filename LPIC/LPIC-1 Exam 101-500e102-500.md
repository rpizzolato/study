...
Nesse arquivo o padrão de entrada é: `facility.priority`(facility é quem está gerando o log, qual aplicação, e priority é o nível do log - debug/info)<br>
Exemplo: mail.err (mail é a facility)



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk5MjI2MjQ1NywtMTQxMTUxMTYzMCwtNT
IwMDU2MjM3XX0=
-->