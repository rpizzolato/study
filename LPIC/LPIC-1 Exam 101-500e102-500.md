...
- `passwd -l lpi2` (ou `--lock`): trava (lock) o usuário `lpi2` (colocar `!` no primeiro caracter do campode senha do `/etc/shadow`) - usando quando precisa investigar o usuário. Para destravar `passwd -u lpi1` (ou `--unlock`): retira a exclamação `/etc/shadow`. Quando estiver

## 110.2 Configurar a segurança do host

## 110.3 Proteção de dados com criptografia
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjY0Nzc1MTgwLC0xMjQxMDgyMTgyLDIxND
E0NzQxNzAsLTQ5ODgwMjgzNiwxMTEzMDYyOTAwLC0xOTU4NTg5
MTc1LC0xODU1MTU4NzgxLDUyNTA0MzMwMSwtMjAyMDUyMTYyNy
wtNTM4MDkwODA3LDQxODYyNTI2MCwxNTczMjQ1MTkwLDEwOTc4
NzU2NjQsLTE3NzgwMTY3NTUsMTU1MDE5NTEyMywtMTY0MTYzOD
Y3LC01MzEzNjMzNCwtNTQzNzgzNDEwLC0yMTA4NjA0MTQ3LDEz
NjY0OTYyMF19
-->