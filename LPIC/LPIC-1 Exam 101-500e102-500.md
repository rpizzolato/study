...
- `/etc/logrotate.conf`: arquivo de configuração do logrotate. Aqui é uma configuração mais geral e genérica, e que incluir o diretório /etc/logrotate.d, que possui as configurações

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk0MDE3ODQwOSwxOTYyNjY0MTczLC01Nz
k1NzAxMzUsLTcyNjA4MDcyNSwzMzI4MzQ2MTgsMTAwMDcxODM1
MCwxNjAzNjE4MjMzLDExNjY0NjEwOSwtMTQwODExMzEwNCwtMT
