...
- `passwd -w4 lpi2` ( ou`--warndays`): número de dias que vai alertar que a senha vai expirar (Number of days of warning before password expires). No `chage`, seria `chage -W` ou 

## 110.2 Configurar a segurança do host

## 110.3 Proteção de dados com criptografia
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5Mzc0MDE0ODUsMjE0MTQ3NDE3MCwtND
