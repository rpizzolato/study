...
- who: mostra quem está logado no sistema, mostrando usuário, o terminal (`tty7` = terminal gráfico) e horário que logou

## 110.2 Configurar a segurança do host

## 110.3 Proteção de dados com criptografia
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgzNTA3NTAyMSwtMTg1NTE1ODc4MSw1Mj
