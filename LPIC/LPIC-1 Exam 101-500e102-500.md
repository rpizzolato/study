...
```
Agora logado como `lpi2`, caso execute `limit -a`, poderá ver que em open files está como `1000` (`soft`). O usuário lpi2 poderá alterar o limite, como por exemplo: `ulimit -n 1500`, vai alterar normalmente. No entanto se alterar da seguinte forma: `ulimit -n 3000` (valor acima do `Hard`) vai dar que a operaç
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTk2MDAzMDE1LDE1OTY5MTE5OTUsLTU0Mz
...
NTg5MTc1LC0xODU1MTU4NzgxLDUyNTA0MzMwMSwtMjAyMDUyMT
YyNywtNTM4MDkwODA3LDQxODYyNTI2MCwxNTczMjQ1MTkwLDEw
OTc4NzU2NjRdfQ==
-->