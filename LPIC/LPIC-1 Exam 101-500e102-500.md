...
Partindo do cenário que `/usr/bin/passwd` tem o bit **SUID** ligado (`rwsr-xr-x`) e que qualquer usuário pode executá-lo como `root` e, diferentemente de `/bin/rm`, que por segurança não possui bit **SUID** ligado (pois qualquer usuário poderia excluir pastas críticas), é interessante monitorar por arquivos com SUID 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDI4NjE3NjEwLC0xODg0OTE3OTkyLDEwND
...
MDUyMTYyNywtNTM4MDkwODA3LDQxODYyNTI2MCwxNTczMjQ1MT
kwLDEwOTc4NzU2NjQsLTE3NzgwMTY3NTUsMTU1MDE5NTEyMywt
MTY0MTYzODY3XX0=
-->