...
Gere um comando, ou sequência deles, que mostre o número de linhas do arquivo `/etc/passwd` excluindo-se as linhas que contenham a palavra  "daemon". O resultado do comando deve ser o número de linhas.
