...
- *Lembrando que essas alterações são em memória, ao reiniciar o PC, ele pegará as configurações do NetworkManager ou outro programa que esteja c

## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MzMyNDQ5NDIsMTUxMDM1NTkxNSwtMT
