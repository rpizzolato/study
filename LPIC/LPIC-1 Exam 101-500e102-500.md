...
Redes que o PC já conector (e conhece):  **/etc/NetworkManager/system-connections**  e dar um  **ls -la**

Se der um cat (com su) mostra até a senha da rede.

## 109.3 Resolução de problemas básicos de rede
## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxNjM5MzcyOSw0ODAxOTA2NTMsLTE5Nz
