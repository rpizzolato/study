...
- `hostname -f` (ou `--fqdn` ou --l): mostra o full qualified domain name (nome completo - hostname + domínio). Nome de domínio pega do `/etc/hosts`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4ODM3Mzg2ODcsNDA3MjY3NzM5LC0xMD
