...
Supondo que a saída do comando `nmcli connection` seja: 
    ...
    enp0s2			ethernet		connected		Wired connection 1
    enp0s4			ethernet		connected		Wired connection 2

Para baixar a `Wired connection 2`, use: `nmcli con down "Wired connection 2"`

- `nmcli connection add type ethernet con-name nome_conexao ifname enp2s0 ip4 192.168.0.20/24 gw4 192.168.0.1`: cria uma nova conexao chamada nome_conexao, na placa enp2s0, com IP 192.168.0.20 máscara 255.255.255.0 e gateway 

## 109.3 Resolução de problemas básicos de rede
## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExOTUxMDQwNTEsODM2MjY4MzAyLDE4ND
czMDEwNzYsMjAwMTg2ODQyMCwtNDM1NzE0NjIyLDE1MzUzMDI0
MzMsLTEyNDUyMTE2ODMsNzk0OTA4NjEwLC0xNTIwODAwNTksLT
UxOTI4NjA2OSwtMjA5NzAyNjgwMywtODg1OTk3MDcwLC04MjM1
NjE4MiwxNDU1MjAwODQ0LC04OTk1Mjc4NTAsLTYzMTYyNTIxMS
wtNTg1OTQzNTY4LC0zMDIxMTc2NzMsMjQ2MzYxNDQ4LC0xMzI3
NzUwODQ2XX0=
-->