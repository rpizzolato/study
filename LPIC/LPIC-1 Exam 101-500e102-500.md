...
- `passwd -l lpi2` (ou `--lock`): trava (lock) o usuário `lpi2` (colocar `!` no primeiro caracter do campode senha do `/etc/shadow`) - usando quando precisa investigar o usuário. Para destravar passwd -u lpi1: retira a exclamação /etc/pass

## 110.2 Configurar a segurança do host

## 110.3 Proteção de dados com criptografia
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2MzI5NzA4NiwyMTQxNDc0MTcwLC00OT
g4MDI4MzYsMTExMzA2MjkwMCwtMTk1ODU4OTE3NSwtMTg1NTE1
ODc4MSw1MjUwNDMzMDEsLTIwMjA1MjE2MjcsLTUzODA5MDgwNy
w0MTg2MjUyNjAsMTU3MzI0NTE5MCwxMDk3ODc1NjY0LC0xNzc4
MDE2NzU1LDE1NTAxOTUxMjMsLTE2NDE2Mzg2NywtNTMxMzYzMz
QsLTU0Mzc4MzQxMCwtMjEwODYwNDE0NywxMzY2NDk2MjAsMTU5
MDI3NzM5MF19
-->