...
- nmcli connection: enquanto device mostra informações referentes ao dispositivo em si, connections mostra informaçoes ~da


## 109.3 Resolução de problemas básicos de rede
## 109.4 Configurar o DNS do lado do cliente
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI2Nzk1MTA1MCwxODQ3MzAxMDc2LDIwMD
