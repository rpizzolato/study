...
Essas modificações, tanto em sistema (`/etc/cron`) como a de usuário, são permanentes, e o arquivo do usuário fica em `/var/spool/cron/crontabs` (precisa ser acesso como **root**)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI1MjU3OTMyNSwxMzM2MDgwNTQ5LDEwND
