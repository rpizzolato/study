...
- `tcpdump`: analisa tráfego de pacotes na rede. Para usar a placa de rede precisa estar em modo promíscuo `allow all`, para permitir capturar tudo que passa pela placa.
...
### Logging
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIwMDgzMzQyNSw2NjkxODgwNjksLTE5ND
