...
Caso não ache, ele vai perguntar para o servidor DNS, no caso, no arquivo `/etc/resolv.conf`, para o servidor que estiver em `nameserver` (Ex. nameserver 192.168.0.50)
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzAzNDA3MzcwLC0xODYyNTkxMDI3LDExOT
