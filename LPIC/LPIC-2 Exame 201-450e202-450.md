...
- `tcpdump` (`apt install tcpdump`): analisa tráfego de pacotes na rede. Para usar a placa de rede precisa estar em modo **promíscuo** `allow all`, para permitir capturar tudo que passa pela placa.
...
### Logging
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDM5NTAyNDc1LDY2OTE4ODA2OSwtMTk0MT
czMjg1NCwtMTYwODY1NDUxNiwtNTIxMjg1MTQwLDE0ODE1OTk1
NDQsLTUyNDczMzY5NSwyMzI2MDczNDcsOTczMTc2MDg1LC0zOT
