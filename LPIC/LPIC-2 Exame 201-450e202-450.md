...
demorar)
- `nmap 192.168.1.0/24 -F`: faz uma varredura de portas de toda a rede `192.168.1.0` com **fast scanner** ( `-F` (Scan Rápido (portas limitadas)) Especifica que você deseja apenas scanear as portas listadas no arquivo nmap-services que vem com o nmap (ou o
           arquivo de protocolos para o -sO). Isto é muito mais rápido do que escanear todas as 65535 portas de um host.
           Pelo fato desta lista conter tantas portas TCP (mais de 1200), a diferença de velocidade de um scan TCP padrão
           (cerca de 1650 portas) não é dramática. A diferença pode ser enorme se você especificar seu próprio minúsculo
           arquivo nmap-services usando a opção --datadir.
)
...
### Logging
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MTA5MTM4ODAsOTc4NzQyNTY3LC0yMD
I3NDU1ODIzLC0xNjkyNTM3MzUsMzgxOTk1Njg4LC0yMDEyNTI5
MDAyLDIwNzY0OTE0MjMsLTExODAzMzQwNCw2NjkxODgwNjksLT
E5NDE3MzI4NTQsLTE2MDg2NTQ1MTYsLTUyMTI4NTE0MCwxNDgx
NTk5NTQ0LC01MjQ3MzM2OTUsMjMyNjA3MzQ3LDk3MzE3NjA4NS
wtMzk0OTUzMjUyLC0xMDg4MjMxODk1LDQ1NjEwNjIxOCwxMjMw
MTEyNzU0XX0=
-->