...
As zonas de domínio ficam sempre em `/var/named`. É aqui que fica o arquivo `named.ca`, onde ficam as listas dos servidores 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjgyMDQ2OTIyLDk3MzE3NjA4NSwtMzk0OT
